    ...
    return (
        <div className="relative p-3 lg:p-5 myShadow rounded flex gap-4 items-center">
            <button onClick={previewFile}>
                <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 0 24 24" width="28px" fill="#2563eb"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6z"/></svg>
            </button>
            <div>
            ...
            <button className="ml-auto bg-gray-100 hover:bg-gray-200 p-4 rounded-full flex items-center justify-center hover:cursor-pointer" onClick={downloadFile}>
