                ...
                <Form className="flex flex-col myShadow w-96 z-10 bg-white rounded-xl">
                    ...
                    <div className="flex flex-col py-5 items-center border-t border-gray-300">
                        ...
                        {(errors.password && touched.password) && (
                            <Fade top>
                                <div className="text-red-500 font-medium z-0 py-1">{errors.password}</div>
                            </Fade>
                        )}
                        <Field 
                        ...
                        {errors.confirmPassword && touched.confirmPassword ? 
                            <Fade top>
                                <div className="text-red-500 font-medium z-0 py-1">{errors.confirmPassword}</div>
                            </Fade> 
                        : null}
                        <Field 
                            name="schoolID" 
                        ...
                        {errors.schoolID && touched.schoolID ? 
                            <Fade top>
                                <div className="text-red-500 font-medium py-1 z-0">{errors.schoolID}</div>
                            </Fade> 
                        : null}
                        <Field 
                            name="classID" 
                        ...
                        {errors.classID && touched.classID ? 
                            <Fade top>
                                <div className="text-red-500 font-medium py-1 z-0">{errors.classID}</div>
                            </Fade> 
                        : null}
                        <Field 
                            name="email" 
                        ...
                        <Fade top>
                            <div className="text-red-500 font-medium py-1 z-0">{errors.email}</div> 
                        </Fade>
                        : null}
                    </div>
                    <div>
