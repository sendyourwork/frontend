...
export default function Main(): JSX.Element {
    return (
        <div className="flex h-85vh font-montserrat relative flex-col lg:flex-row items-center xl:items-start overflow-x-hidden">
            <Fade top>
                <img src="/Star 6.svg" className="left-4 transform hover:rotate-180 hover:scale-125 transition duration-500 hidden lg:block absolute" />
                <img src="/Rectangle90.svg" className="top-3/4 left-1/4 transform hover:rotate-180 hover:scale-150 transition duration-500 hidden lg:block absolute" />
                <img src="/Circle91.svg" className="bottom-8 left-2/4 transform hover:rotate-180 hover:scale-125 transition duration-500 hidden lg:block absolute" />
                <img src="/Rectangle93.svg" className="top-12 left-2/4 transform hover:rotate-180 hover:scale-150 transition duration-500 hidden lg:block absolute" />
                <img src="/Rectangle94.svg" className="right-12 top-3/4 transform hover:rotate-180 hover:scale-50 transition duration-500 hidden lg:block absolute" />
            </Fade>
            <Fade left delay={700}>
