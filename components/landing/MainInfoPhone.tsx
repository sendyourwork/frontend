...
export default function MainInfoPhone(): JSX.Element {
    return (
        <div className="mx-auto relative flex flex-col justify-center items-center h-screen font-montserrat mt-24 md:mt-0" id="downloadInfo">
            ...
            <div className="mx-auto">
                <span className="text-3xl font-bold text-center">Download our <span className="text-greenLight">App</span> on: </span>
                <div className="mt-5 text-center">
                    <button className="bg-main rounded-md text-white w-52 h-8 font-normal">
                        <a href={BACKEND_URL + "/SendYourWork.apk"} download>Download .apk here</a>
                    </button>
                </div>
            </div>
