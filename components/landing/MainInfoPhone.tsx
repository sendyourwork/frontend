export default function MainInfoPhone(): JSX.Element {
    return (
        <div className="relative flex flex-col justify-center items-center h-screen font-montserrat">
            <img src="/Star 8.svg" className="absolute top-24 right-12" />
            <img src="/Circle91.svg" className="absolute w-16 top-2 left-12" />
            <img src="/Rectangle94.svg" className="w-16 absolute bottom-12 left-12" />
            ...
            <div className=" flex flex-col">
                <div className="mt-12 flex items-center justify-left">
                    <img src="/google-play-logo.png" className="w-10" />
                ...
                <div className="mt-2 flex items-center justify-left">
                    <img src="/ios-app-store-hero.png" className="w-10" />
