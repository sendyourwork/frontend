export default function ProjectInfo(): JSX.Element {
    return (
        <div className="flex h-screen relative font-montserrat">
            <img src="/Star 6.svg" className="left-12 top-20 absolute hidden lg:block" />
            <img src="/Rectangle90.svg" className="bottom-10 left-40 absolute hidden lg:block" />
            <img src="/Rectangle93.svg" className="top-8 right-52 absolute hidden lg:block" />
            <img src="/Rectangle94.svg" className="right-12 top-3/4 absolute hidden lg:block" />
