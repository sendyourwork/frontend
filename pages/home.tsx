...
const Home: NextPage = () => {
    ...
    return (
        <>
            ...
            <div className="p-7 md:py-14 md:px-12 flex flex-col w-full xl:grid xl:grid-cols-home">
                ...
                <div className="flex flex-col order-1 mb-5 xl:mb-0 xl:order-none justify-between">
                    <UserInfo name="Artiu"/>
                    <Chat />
                </div>
            </div>
