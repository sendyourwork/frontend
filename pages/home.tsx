...
const Home: NextPage = () => {
    ...
    return (
        <>
            ...
            <div className="p-7 md:py-14 md:px-12 w-full flex flex-col xl:flex-row max-h-screen">
                <div className="order-2 w-full xl:w-4/5 xl:order-none">
                    <div className="flex flex-col px-3 gap-9 xl:flex-row">
                        <div className="myShadow w-full pl-5 flex items-center xl:w-1/2">
                            ...
                            <input type="text"
                                value={searchValue}
                                className="outline-none ml-2 max-w-full"
                                placeholder="Search"
